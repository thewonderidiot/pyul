...
class AgcPass2(Pass2):
    ...
    # Subroutine in pass 2 for AGC to set in print a right-hand location for such as SETLOC.
    ...
    # Subroutine in pass 2 for AGC to set in print the location of an instruction or constant, with bank
    ...
    # Minor subroutine in pass 2 for AGC to cuss a double precision constant that crosses a bank boundary.
    def dp_cross_q(self, dp):
        if dp:
            self.cuss_list[84].demand = True

    # Subroutine in pass 2 for AGC to set up a single-precision constant in word and in print. This subroutine
    ...
    # Subroutine in pass 2 for AGC to process a single-precision constant. Using the output of DEC CONST or
    ...
    def int_ad_f(self, popo, check_min=True):
        # F type addr cannot be less than 20000 nor greater thank AGC address max
