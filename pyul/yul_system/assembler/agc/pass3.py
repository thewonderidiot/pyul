...
class AgcPass3(Pass3):
    ...
    # Subroutine in pass 3 for AGC to set in print the definition of a symbol or the upper limit of an
    ...
    # Subroutine in pass 3 for AGC to set in print the upper address limit, paragraph number, rope module
    ...
    # Subroutine in pass 3 for AGC to print two explanatory lines at the head of each page of
